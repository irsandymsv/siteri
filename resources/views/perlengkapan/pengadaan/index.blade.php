     ...
     <div class="col-xs-12">
           <div class="box box-success">
              ...
              <div style="float: right;">
            	<a href="{{ route('perlengkapan.pengadaan.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Buat Laporan</a>
              </div>
            </div>
		            	...
		            	<tbody>
		            		...
		            		@foreach($laporan as $item)
                                <tr id="lap_{{ $item->id }}">
		            				...
		            				<td>
                                        <a href="{{ route('perlengkapan.pengadaan.show', $item->id) }}" class="btn btn-primary" title="Lihat Laporan"><i class="fa fa-eye"></i></a>
                                        @if($item->verif_wadek2 != 1)
                                        <a href="{{ route('perlengkapan.pengadaan.edit', $item->id) }}" class="btn btn-warning" title="Ubah Laporan"><i class="fa fa-edit"></i></a>
                                        @endif
						              	@if($item->verif_wadek2 != 1)
