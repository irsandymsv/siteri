            ...
            <table id="example2" class="table table-bordered table-hover dataTable" role="grid"
              ...
              <thead>
                ...
                <tr role="row">
                  ...
                  <td>{{$sk->keterangan}}</td>
                  <td>
                    <a href="{{route('kepegawaian.surat.preview', $sk->id)}}" class="btn btn-primary btn-sm" style="margin-left: 17px;"><i class="fa fa-eye"></i></a>
                    @if ($sk->surat_in_out==1)
                    @if ($sk->jenis_surat == 1)
                    <a href="{{route('kepegawaian.surat.cetak1', $sk->id)}}" class="btn btn-warning btn-sm" ><i class="fa fa-print"></i></a>
                    @elseif($sk->jenis_surat == 2)
                    <a href="{{route('kepegawaian.surat.cetak2', $sk->id)}}" class="btn btn-warning btn-sm" ><i class="fa fa-print"></i></a>
                    @elseif($sk->jenis_surat == 3)
                    <a href="{{route('kepegawaian.surat.cetak1', $sk->id)}}" class="btn btn-warning btn-sm" ><i class="fa fa-print"></i></a>
                    @endif  
                    @endif

                    @if ($sk->surat_in_out == 2)
                    <a href="{{route('kepegawaian.surat.cetak3', $sk->id)}}" class="btn btn-warning btn-sm" ><i class="fa fa-print"></i></a>
                    @endif
