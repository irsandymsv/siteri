               ...
               <div class="box-body">
                  ...
                  @if($sk_honor->verif_dekan != 1)
                     <div class="form-group" style="float: right;">
                        <form method="post" action="{{ ( $sk_honor->tipe_sk->tipe == "SK Skripsi"? route('ktu.honor-skripsi.verif', $sk_honor->id) : route('ktu.honor-sempro.verif', $sk_honor->id) ) }}">
                           @csrf
                           @method('put')
                           <input type="hidden" name="verif_ktu" value="{{$sk_honor->verif_ktu}}">
