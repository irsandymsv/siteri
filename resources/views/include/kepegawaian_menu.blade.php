<li><a href="{{ route('kepegawaian.dashboard') }}"><i class="fa fa-dashboard"></i> <span>Dashboard Kepegawaian</span></a></li>

<li><a href="{{route('kepegawaian.surat.index')}}"><i class="fa fa-link"></i> <span>Daftar Surat tugas</span></a></li>
...
<li class="treeview">
    ...
    <ul class="treeview-menu">
      <li><a href="{{route('kepegawaian.pegawai.create')}}">Buat Baru</a></li>
      <li><a href="{{ route('kepegawaian.pegawai.index') }}">Lihat Semua</a></li>
    </ul>
</li>
