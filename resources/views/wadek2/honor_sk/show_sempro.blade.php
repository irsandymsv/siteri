         ...
         <div class="box-footer">
            {{-- @if ($sk_honor->verif_wadek2 != 1)
               <div class="form-group" style="float: right;">
                  <form method="post" action="{{ route('wadek2.honor-sempro.verif', $sk_honor->id) }}">
                     @csrf
                     @method('put')
                     <input type="hidden" name="verif_wadek2" value="{{$sk_honor->verif_wadek2}}">
            ...
            <a href="{{ route('wadek2.honor-sempro.index') }}" class="btn btn-default pull-right">Kembali</a>
         </div>
      </div>
    </div>
   </div>
