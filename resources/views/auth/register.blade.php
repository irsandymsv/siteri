                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="np_pegawai" type="text" class="form-control @error('no_pegawai') is-invalid @enderror" name="no_pegawai" value="{{ old('no_pegawai') }}" required autocomplete="no_pegawai" autofocus>
