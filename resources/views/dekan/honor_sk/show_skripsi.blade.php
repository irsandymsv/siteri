      ...
      <div class="col-xs-12">
         <div class="box box-primary">
            ...
            <div class="box-footer">
               <a href="{{ route('dekan.honor-skripsi.index') }}" class="btn btn-default pull-right">Kembali</a>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="col-xs-12">
         @if($sk_honor->verif_dekan != 1)
            <div class="form-group" style="float: right;">
               <form method="post" action="{{ route('dekan.honor-skripsi.verif', $sk_honor->id) }}">
                  @csrf
                  @method('put')
                  <input type="hidden" name="verif_dekan" value="{{$sk_honor->verif_kebag_keuangan}}">
