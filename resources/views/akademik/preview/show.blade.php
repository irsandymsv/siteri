   	...
   	<div class="col-xs-12">
   		<div class="box box-primary">
            ...
            <div  class="box-footer">
               ...
               <a style="margin-left: 3px;" href="{{ route('ktu.surat.approve', $surat_tugas->id) }}" class="btn btn-primary pull-right"> Setujui </a> 
               <a href="{{ route('ktu.surat.reject.view', $surat_tugas->id) }}" class="btn btn-danger pull-right"> Tolak </a> 
            </div>
