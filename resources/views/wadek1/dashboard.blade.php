				      	...
				      	@else
	   			      	@foreach ($sutgas_pembimbing_1 as $item)
	   			      		<tr>
	   			      			...
	   			      			<td>
   			      					<a href="{{ route('wadek1.pembimbing-skripsi.show', $item->detail_skripsi->skripsi->nim) }}" title="Lihat Detail" class="btn btn-primary"><i class="fa fa-eye"></i></a>
				      				</td>
	   			      		</tr>
	   			      	@endforeach
				      	@endif
				      	...
				      	@else
	   			      	@foreach ($sutgas_pembahas_1 as $item)
	   			      		<tr>
	   			      			...
	   			      			<td>{{ $item->detail_skripsi->skripsi->mahasiswa->prodi->nama }}</td>
	   			      			<td>
   			      					<a href="{{ route('wadek1.pembahas-sempro.show', $item->detail_skripsi->skripsi->nim) }}" title="Lihat Detail" class="btn btn-primary"><i class="fa fa-eye"></i></a>
				      				</td>
	   			      		</tr>
	   			      	@endforeach
				      	@endif
				      	...
				      	@else
	   			      	@foreach ($sutgas_penguji_1 as $item)
	   			      		<tr>
	   			      			...
	   			      			<td>{{ $item->detail_skripsi->skripsi->mahasiswa->prodi->nama }}</td>
	   			      			<td>
   			      					<a href="{{ route('wadek1.penguji-skripsi.show', $item->detail_skripsi->skripsi->nim) }}" title="Lihat Detail" class="btn btn-primary"><i class="fa fa-eye"></i></a>
				      				</td>
	   			      		</tr>
	   			      	@endforeach
				      	@endif
