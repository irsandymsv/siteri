                     ...
                     <tbody>
                        <?php $__currentLoopData = $sk_honor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <tr id="sk_<?php echo e($item->id); ?>">
                              ...
                              <td>
                                 <?php if($tipe == "SK Skripsi"): ?>
                                    <a href="<?php echo e(route('ktu.honor-skripsi.show', $item->id)); ?>" class="btn btn-primary" title="Lihat Detail"><i class="fa fa-eye"></i></a>
                                 <?php else: ?>
                                    <a href="<?php echo e(route('ktu.honor-sempro.show', $item->id)); ?>" class="btn btn-primary" title="Lihat Detail"><i class="fa fa-eye"></i></a>
                                 <?php endif; ?>
                              </td>
                           </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\siteri\resources\views/ktu/honor_sk/honor_index.blade.php ENDPATH**/ ?>