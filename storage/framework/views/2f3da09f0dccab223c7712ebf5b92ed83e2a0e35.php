   		...
   		<div class="box box-primary">
               ...
               <?php if($surat_tugas->verif_ktu == 1): ?>
                  <div style="float: right;">
                     <a href="<?php echo e(route("akademik.sutgas-pembimbing.cetak", $surat_tugas->id)); ?>" class="btn bg-teal"><i class="fa fa-print"></i> Download PDF</a>
                  </div>
               <?php endif; ?>
                  ...
                  <table class="table table-striped table-bordered">
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <p><?php echo e($surat_tugas->dosen1->no_pegawai); ?></p>
                        </td>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <p><?php echo e($surat_tugas->dosen2->no_pegawai); ?></p>
                        </td>
                     </tr>

                     <tr>
                        <td>Keris</td>
                        <td><?php echo e($surat_tugas->detail_skripsi->keris->nama); ?></td>
                     </tr>
            ...
            <div class="box-footer">
               <a href="<?php echo e(route('akademik.sutgas-pembimbing.index')); ?>" class="btn btn-default">Kembali</a>
               <a href="<?php echo e(route('akademik.sutgas-pembimbing.edit', $surat_tugas->id)); ?>" class="btn btn-warning pull-right"><i class="fa fa-edit"></i> Ubah</a> &ensp;   
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\siteri\resources\views/akademik/sutgas_pembimbing/show.blade.php ENDPATH**/ ?>