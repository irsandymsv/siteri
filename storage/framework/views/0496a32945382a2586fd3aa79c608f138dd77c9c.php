	...
	<div class="row">
   	<div class="col-xs-12">
   		<div class="box box-primary">
            ...
            <form action="<?php echo e(route('akademik.sutgas-pembahas.store')); ?>" method="post">
            	<?php echo csrf_field(); ?>
               <div class="box-body">
...
if (isset($messageCache)) { $message = $messageCache; }
                  ...
                  <div class="form-group">
                     ...
                     <textarea name="judul_inggris" id="judul_inggris" class="form-control" rows="3"><?php echo e(old('judul_inggris')); ?></textarea>

                     <?php if ($errors->has('judul_inggris')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('judul_inggris'); ?>
                        <span class="invalid-feedback" role="alert" style="color: red;">
                           <strong><?php echo e($message); ?></strong>
                        </span>
                     <?php unset($message);
...
if (isset($messageCache)) { $message = $messageCache; }
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="jam" class="form-control timepicker" style="font-size: 16px; width: 60%;" value="<?php echo e(old('jam')); ?>"> <b style="font-size: 15px;">WIB</b>
            		...
            		<div class="form-group">
            			...
            			<select name="id_pembahas1" id="id_pembahas1" class="form-control select2">
            				...
            				<?php $__currentLoopData = $dosen1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            					<option value="<?php echo e($item->no_pegawai); ?>" <?php echo e(($item->no_pegawai == old('id_pembahas1')? 'selected' : '')); ?>>
                     ...
                     <?php if ($errors->has('id_pembahas1')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('id_pembahas1'); ?>
                        <span class="invalid-feedback" role="alert" style="color: red;">
                            <strong><?php echo e($message); ?></strong>
                        </span>
                     <?php unset($message);
            		...
            		<div class="form-group">
            			...
            			<select name="id_pembahas2" id="id_pembahas2" class="form-control select2">
            				...
            				<?php $__currentLoopData = $dosen2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            					<option value="<?php echo e($item->no_pegawai); ?>" <?php echo e(($item->no_pegawai == old('id_pembahas2')? 'selected' : '')); ?>>
                              <?php echo e($item->nama); ?>
                     ...
                     <?php if ($errors->has('id_pembahas2')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('id_pembahas2'); ?>
                        <span class="invalid-feedback" role="alert" style="color: red;">
                            <strong><?php echo e($message); ?></strong>
                        </span>
                     <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
               ...
               <div class="box-footer">
                  ...
                  <a href="<?php echo e(route('akademik.sutgas-pembahas.index')); ?>" class="btn btn-default">Batal</a> &ensp;
   ...
   <script src="<?php echo e(asset('/adminlte/plugins/timepicker/bootstrap-timepicker.min.js')); ?>"></script>
	...
	<script type="text/javascript">
      ...
      if(nim_old != null){
         ...
         var old_id_pembahas1 = <?php echo json_encode(old('id_pembahas1'), 15, 512) ?>;
         var old_id_pembahas2 = <?php echo json_encode(old('id_pembahas2'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\siteri\resources\views/akademik/sutgas_pembahas/create.blade.php ENDPATH**/ ?>