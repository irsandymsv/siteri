		...
		<div class="col col-md-6">
			<div class="box box-warning">
			  	<div class="box-header with-border">
			   	...
			   	<div class="box-tools">
			   		<a href="<?php echo e(route('dekan.sk-sempro.index')); ?>" class="btn btn-default">Lihat Semua</a>
			   	</div>
			  	</div>
			  <!-- /.box-header -->
			  <div class="box-body">
				      	...
				      	<?php else: ?>
	   			      	<?php $__currentLoopData = $sk_sempro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	   			      		<tr>
	   			      			...
	   			      			<td>
				      					<a href="<?php echo e(route('dekan.sk-sempro.show', $item->no_surat)); ?>" title="Lihat Detail" class="btn btn-primary"><i class="fa fa-eye"></i></a>
				      				</td>
	   			      		</tr>
		...
		<div class="col col-md-6">
			<div class="box box-success">
			  	<div class="box-header with-border">
			   	...
			   	<div class="box-tools">
			   		<a href="<?php echo e(route('dekan.sk-skripsi.index')); ?>" class="btn btn-default">Lihat Semua</a>
			   	</div>
			  	</div>
			  	<!-- /.box-header -->
			  	<div class="box-body">
				      	...
				      	<?php else: ?>
	   			      	<?php $__currentLoopData = $sk_skripsi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	   			      		<tr>
	   			      			...
	   			      			<td><?php echo e(Carbon\Carbon::parse($item->created_at)->locale('id_ID')->isoFormat('D MMMM Y')); ?></td>
	   			      			<td>
				      					<a href="<?php echo e(route('dekan.sk-skripsi.show', $item->id)); ?>" title="Lihat Detail" class="btn btn-primary"><i class="fa fa-eye"></i></a>
				      				</td>
	   			      		</tr>
	   			      	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				      	<?php endif; ?>
		...
		<div class="col col-md-6">
			<div class="box box-primary">
			  	<div class="box-header with-border">
			   	...
			   	<div class="box-tools">
			   		<a href="<?php echo e(route('dekan.honor-sempro.index')); ?>" class="btn btn-default" title="Lihat Semua SK Sempro">Lihat Semua</a>
			   	</div>
			  	</div>
			  <!-- /.box-header -->
			  <div class="box-body">
				      	...
				      	<?php else: ?>
	   			      	<?php $__currentLoopData = $sk_honor_sempro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	   			      		<tr>
	   			      			...
	   			      			<td>
				      					<a href="<?php echo e(route('dekan.honor-sempro.show', $item->id)); ?>" title="Lihat Detail" class="btn btn-primary"><i class="fa fa-eye"></i></a>
				      				</td>
	   			      		</tr>
	   			      	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				      	<?php endif; ?>
		...
		<div class="col col-md-6">
			<div class="box box-danger">
				  	<div class="box-header with-border">
				   	...
				   	<div class="box-tools">
				   		<a href="<?php echo e(route('dekan.honor-skripsi.index')); ?>" class="btn btn-default" title="Lihat Semua SK Skripsi">Lihat Semua</a>
				   	</div>
				  	</div>
				  <!-- /.box-header -->
				  <div class="box-body">
					      	...
					      	<?php else: ?>
		   			      	<?php $__currentLoopData = $sk_honor_skripsi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		   			      		<tr>
		   			      			...
		   			      			<td>
					      					<a href="<?php echo e(route('dekan.honor-skripsi.show', $item->id)); ?>" title="Lihat Detail" class="btn btn-primary"><i class="fa fa-eye"></i></a>
					      				</td>
		   			      		</tr>
		   			      	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					      	<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\siteri\resources\views/dekan/dashboard.blade.php ENDPATH**/ ?>